...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadingFeedCompletion_rendersSuccessfullyLoadedFeed() {
    ...
    func test_loadingFeedCompletion_doesNotAlterCurrentRenderingStateOnError() {
        let image0 = makeImage(description: "a description", location: "a location")
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImages() {
        ...
        XCTAssertEqual(view1?.isShowingImageLoadingIndicator, false, "Expected no loading indicator for second view second first image loading completes with error")
    }
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
        ...
        XCTAssertEqual(view1?.renderedImage, imageData1, "Expected image for second view once second image loading completes with successfully")
    }
    
    func test_feedImageViewRetryButton_isVissibleOnImageURLLoadError() {
        let (sut, loader) = makeSUT()
...
private extension FeedViewController {
    ...
    var numberOfRenderedFeedImages: Int {
...
private extension FeedImageCell {
    var isShowingLocation: Bool {
        !self.locationContainer.isHidden
    }
    
    var isShowingImageLoadingIndicator: Bool {
        self.feedImageContainer.isShimmering
    }
    
    var isShowingRetryAction: Bool {
        !self.feedImageRetryButton.isHidden
    }
